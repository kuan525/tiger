...
var file_gateway_proto_rawDesc = []byte{
	...
	0x07, 0x73, 0x65, 0x72, 0x63, 0x69, 0x76, 0x65, 0x22, 0x34, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65,
	...
	0x2e, 0x73, 0x65, 0x72, 0x63, 0x69, 0x76, 0x65, 0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x63, 0x69, 0x76,
	0x65, 0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x39, 0x0a, 0x04, 0x50, 0x75, 0x73, 0x68, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x63,
	0x69, 0x76, 0x65, 0x2e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x63, 0x69, 0x76, 0x65, 0x2e, 0x47, 0x61, 0x74,
...
var file_gateway_proto_goTypes = []interface{}{
	(*GatewayRequest)(nil),  // 0: sercive.GatewayRequest
	(*GatewayResponse)(nil), // 1: sercive.GatewayResponse
}
var file_gateway_proto_depIdxs = []int32{
	0, // 0: sercive.Gateway.DelConn:input_type -> sercive.GatewayRequest
	0, // 1: sercive.Gateway.Push:input_type -> sercive.GatewayRequest
	1, // 2: sercive.Gateway.DelConn:output_type -> sercive.GatewayResponse
	1, // 3: sercive.Gateway.Push:output_type -> sercive.GatewayResponse
...
func (c *gatewayClient) DelConn(ctx context.Context, in *GatewayRequest, opts ...grpc.CallOption) (*GatewayResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sercive.Gateway/DelConn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) Push(ctx context.Context, in *GatewayRequest, opts ...grpc.CallOption) (*GatewayResponse, error) {
	out := new(GatewayResponse)
	err := c.cc.Invoke(ctx, "/sercive.Gateway/Push", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_DelConn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sercive.Gateway/DelConn",
	}
...
func _Gateway_Push_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sercive.Gateway/Push",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
